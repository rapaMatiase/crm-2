...
export default function RouteImage(): JSX.Element {
    ...
    const cellAction = (props: any) => (
        <td {...props.tdProps}>
          <Button onClick={() => {
            ...
            navigate(`/CMSDefinirProductos/productos/${idProducto}/nombreProducto/${nombreProducto}/imagenes/delete/${dataItem.idMediaEntity}`)
          }}>Borrar</Button>
        </td>
      )
  ...
  const handleEditarImagen = () => {
    navigate(`/CMSDefinirProductos/productos/${idProducto}/nombreProducto/${nombreProducto}/imagenes/edit`)
  }
