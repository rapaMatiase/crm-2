...
import { GetGruposProductos } from '~/api/ApiAtributos';
            ...
            <Form
                ...
                render={(formRenderProps: FormRenderProps) => (
                    <FormElement style={{ maxWidth: 650 }}>
                        ...
                        <Field
                            name={'idGruposProducto'}
                            component={Input}
                            value={formData.idGruposProducto}
                            onChange={handleChange}
                            label={'ID Grupo Producto'} />
                        ...
                        >
                            <GridColumn field="idGruposProducto" title="ID Grupos Producto" />
