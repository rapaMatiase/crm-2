...
//ACTION FUNCTION
 export const action: ActionFunction = async ({ request, params }) => {
  const {  idSegmento,  nombreSegmento } = params as { idSegmento: string, nombreSegmento: string };
  ...
  const response = await postSetImagen({ request, tipoEntidad, idEntidad: idSegmento, data });
...
export default function CMSDefinirSegmentosEdit() {
