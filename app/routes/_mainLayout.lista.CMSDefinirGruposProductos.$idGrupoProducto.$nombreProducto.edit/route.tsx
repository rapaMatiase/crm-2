...
//ACTION FUNCTION
 export const action: ActionFunction = async ({ request, params }) => {
  const {  idGrupoProducto,  nombreProducto } = params as { idGrupoProducto: string, nombreProducto: string };
  ...
  const response = await postSetImagen({ request, tipoEntidad, idEntidad: idGrupoProducto, data });
...
export default function CMSDefinirGruposProductosEdit() {
